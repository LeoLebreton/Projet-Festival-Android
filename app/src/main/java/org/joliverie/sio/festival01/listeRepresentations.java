...
public class listeRepresentations extends AppCompatActivity {
    ...
    private static final String URL_XMLRESSOURCE = "http://192.168.56.1/FestivalPHP/rest/getAllRepresentations.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*listViewRepresentations.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(listeRepresentations.this, vueUneRepresentation.class);
                intent.putExtra("Representation", listViewRepresentations.getItemAtPosition(position).toString());
        ...
        listViewRepresentations.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(getApplicationContext(), "Représentation sélectionnée : " + listViewRepresentations.getAdapter().getItem(position), Toast.LENGTH_SHORT).show();
                Bundle bundle = new Bundle();
                bundle.putString("representation", listViewRepresentations.getAdapter().getItem(position).toString());
                ...
                bundle.putString("heureDebut", ((Representation)listViewRepresentations.getAdapter().getItem(position)).getHeureDebut());
                bundle.putString("heureFin", ((Representation)listViewRepresentations.getAdapter().getItem(position)).getHeureFin());
                Intent infos = new Intent(getApplicationContext(), vueUneRepresentation.class);
                infos.putExtras(bundle);
                startActivity(infos);
            }
        });
    ...
    public class ReqHTTPTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            // modification de la liste des représentations
        ...
        protected void onPostExecute(final Boolean success) {
            if (success) {
                ...
                Toast.makeText(getApplicationContext(), "Affichage de la liste : " + success,
